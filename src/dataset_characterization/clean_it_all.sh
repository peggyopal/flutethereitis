...
python clean_embeddings.py ../../data/bal_train ../../data/clean_data/balanced_train_segments_cleaned.csv flute
echo "\nThat was tense!"
echo "\n\n"
...
python clean_embeddings.py ../../data/unbal_train ../../data/clean_data/unbalanced_train_segments_cleaned.csv flute
echo "\nAlmost there..."
echo "\n\n"
...
python clean_embeddings.py ../../data/eval ../../data/clean_data/eval_segments_cleaned.csv flute
echo "\nYAY! ALL DONE!."
echo "\n\n"
